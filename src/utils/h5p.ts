...
export const H5P_CDN_URLS = {
  'multiple-choice': 'https://h5p.org/h5p/embed/162', // Multi Choice example
  'fill-in-blanks': 'https://h5p.org/h5p/embed/82',   // Fill in blanks example
  'drag-drop': 'https://h5p.org/h5p/embed/66',        // Drag and drop example
  'matching': 'https://h5p.org/h5p/embed/120',        // Matching game example
  'sorting': 'https://h5p.org/h5p/embed/115',         // Sorting example
}
